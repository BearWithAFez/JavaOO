...
import vierkantsvergelijking.VierkantsVergelijking;
...
public class GUI extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        // Create vierkantsVergelijking object
        vk = new VierkantsVergelijking(a, b, c);
        double[] res = vk.losOp();
        ...
        if (res == null){
            ...
            jLabelX1.setText(res[0] + "");
            jLabelX2.setText("***");
        } else {   
            jLabelX1.setText(res[0] + "");   
            jLabelX2.setText(res[1] + "");
        }
